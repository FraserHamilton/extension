...
var Argument = /** @class */ (function () {
    function Argument(name, friendlyName, description, givenValue, hasDefaultValue, aliases, undocumented) {
    ...
    Argument.prototype.val = function (noPrompt) {
        ...
        return this.initializePromise.then(function () {
            if (_this.assignedValue !== undefined) {
                ...
                if (!noPrompt && !_this.undocumented) {
                    if (common.NO_PROMPT) {
                        throw new Error("Missing required value for argument '" + _this.name + "'.");
                    }
 ...
 */
var ArrayArgument = /** @class */ (function (_super) {
 ...
 */
var FilePathsArgument = /** @class */ (function (_super) {
 ...
 */
var ExistingFilePathsArgument = /** @class */ (function (_super) {
    ...
    ExistingFilePathsArgument.prototype.getValue = function (argParams) {
        return _super.prototype.getValue.call(this, argParams).then(function (paths) {
            ...
            paths.forEach(function (p) {
                var promise = fsUtils.exists(p).then(function (exists) {
                    if (!exists) {
 ...
 */
var WritableFilePathsArgument = /** @class */ (function (_super) {
    ...
    WritableFilePathsArgument.prototype.getValue = function (argParams) {
        return _super.prototype.getValue.call(this, argParams).then(function (paths) {
            ...
            paths.forEach(function (p) {
                var promise = fsUtils.canWriteTo(p).then(function (canWrite) {
                    if (canWrite) {
                        return p;
                    }
                    else {
 ...
 */
var ReadableFilePathsArgument = /** @class */ (function (_super) {
    ...
    ReadableFilePathsArgument.prototype.getValue = function (argParams) {
        return _super.prototype.getValue.call(this, argParams).then(function (paths) {
            var canReadPromises = [];
            paths.forEach(function (p) {
                var promise = fsUtils.fileAccess(p, fsUtils.R_OK).then(function (canRead) {
                    if (canRead) {
                        return p;
                    }
                    else {
 ...
 */
var ExistingDirectoriesArgument = /** @class */ (function (_super) {
    ...
    ExistingDirectoriesArgument.prototype.getValue = function (argParams) {
        return _super.prototype.getValue.call(this, argParams).then(function (paths) {
            ...
            paths.forEach(function (p) {
                var promise = util_1.promisify(fs_1.lstat)(p).then(function (stats) {
 ...
 */
var BooleanArgument = /** @class */ (function (_super) {
 ...
 */
var IntArgument = /** @class */ (function (_super) {
 ...
 */
var FloatArgument = /** @class */ (function (_super) {
 ...
 */
var JsonArgument = /** @class */ (function (_super) {
 ...
 * by a single space.
 */
var StringArgument = /** @class */ (function (_super) {
 ...
 */
var SilentStringArgument = /** @class */ (function (_super) {
