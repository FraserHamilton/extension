...
var TfCommand = /** @class */ (function () {
     ...
     */
    TfCommand.prototype.registerCommandArgument = function (name, friendlyName, description, ctor, defaultValue, undocumented) {
        ...
        if (argValue) {
            ...
            this.commandArgs[argName] = new ctor(argName, friendlyName, description, defaultValue, true, argAliases, undocumented);
        }
    };
    /**
    ...
    TfCommand.prototype.output = function (data) {
        ...
        return this.commandArgs.output.val().then(function (outputDestination) {
            switch (outputDestination.toLowerCase()) {
                ...
                case "clip":
                case "clipboard":
                    var clipboardText_1 = _this.getClipboardOutput(data);
                    return new Promise(function (resolve) {
                        copypaste.copy(clipboardText_1, function () {
                            resolve();
                        });
                    });
                default:
